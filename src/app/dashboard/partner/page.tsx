                ...
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6">
                    <div className="space-y-1">
                        <div className="flex items-center gap-2">
                            ...
                            {/* Verification Badge */}
                            {seller?.profile?.onboarding_status === 'verified' ? (
                                <div className="ml-2 flex items-center gap-1.5 bg-green-50 text-green-700 px-3 py-1 rounded-lg border border-green-100 italic">
                                    <CheckCircle2 className="w-3.5 h-3.5" />
                                    <span className="text-[10px] font-black uppercase tracking-tight">Verified Merchant</span>
                                </div>
                            ) : (
                                <div className="ml-2 flex items-center gap-1.5 bg-amber-50 text-amber-700 px-3 py-1 rounded-lg border border-amber-100 italic">
                                    <Clock className="w-3.5 h-3.5" />
                                    <span className="text-[10px] font-black uppercase tracking-tight">Syncing with Legal Hub</span>
                                </div>
                            )}
                        </div>
                        ...
                        <Card className="w-full max-w-2xl bg-white rounded-[40px] shadow-2xl relative overflow-hidden flex flex-col max-h-[90vh]">
                            <div className="p-8 border-b border-neutral-100 flex justify-between items-center sticky top-0 bg-white z-10">
                                ...
                                <Button variant="ghost" onClick={() => setShowEditProfile(false)} className="rounded-full w-12 h-12 hover:bg-neutral-100">
                                    <ShieldAlert className="w-6 h-6 text-neutral-300" />
                                </Button>
                            </div>
