...
export function PromotionalBanner() {
    ...
    const offers = [
        {
            title: t.promo_interior_title,
            description: t.promo_interior_desc,
            cta: t.promo_interior_cta,
            color: "bg-blue-600",
        ...
        {
            title: t.promo_health_title,
            description: t.promo_health_desc,
            cta: t.promo_health_cta,
        ...
        {
            title: t.promo_bulk_title,
            description: t.promo_bulk_desc,
            cta: t.promo_bulk_cta,
            color: "bg-orange-500",
